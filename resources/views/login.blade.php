					...
					<div class="card mb-0">
						<div class="card-body">
							<div class="text-center mb-3">
								<img src="/global_assets/images/logo1.png" width="90%" />
								<span class="d-block text-muted">Faça login na sua conta</span>
							</div>

                            @if(isset($error) && isset($error['title']))
                            <div class="text-center mb-3">
                                <span class="d-block alert-danger p-1">{{$error['title']}}</span>
                            </div>
                            @endif
							...
							<div class="form-group">
								<a href="/#" class="btn btn-light btn-block">Cadastrar</a>
							</div>
