			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Troca de pedidos</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="" class="breadcrumb-item">Troca de pedidos</a>
						</div>
										...
										<div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
											...
											<div class="text-sm-right mb-0 mt-3 mt-sm-0 ml-auto">
												...
												<ul class="list list-unstyled mb-0">
													...
													<li class="dropdown">
														Status: &nbsp;
														<a href="#" class="badge bg-success-400 align-top dropdown-toggle" data-toggle="dropdown">Pago</a>
														<div class="dropdown-menu dropdown-menu-right">
															<a href="#" class="dropdown-item active"><i class="icon-alert"></i> Aberto</a>
															<a href="#" class="dropdown-item"><i class="icon-alarm"></i> Aguardando</a>
															<a href="#" class="dropdown-item"><i class="icon-checkmark3"></i> pago</a>															
										...
										<div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
											...
											<div class="text-sm-right mb-0 mt-3 mt-sm-0 ml-auto">
												...
												<ul class="list list-unstyled mb-0">
													...
													<li class="dropdown">
														Status: &nbsp;
														<a href="#" class="badge bg-primary-400 align-top dropdown-toggle" data-toggle="dropdown">Aguardando</a>
														<div class="dropdown-menu dropdown-menu-right">
															<a href="#" class="dropdown-item active"><i class="icon-alert"></i> Aberto</a>
															<a href="#" class="dropdown-item"><i class="icon-alarm"></i> Aguardando</a>
															<a href="#" class="dropdown-item"><i class="icon-checkmark3"></i> pago</a>															
