				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<div class="d-flex justify-content-center">
							<a href="marcas-lista.php" class="btn btn-link btn-float text-default"><i class="icon-list text-primary"></i><span>Ver Todos</span></a>
						</div>
					</div>
				</div>
								...
								<div class="col-md-12">
									<fieldset>
										...
										<div class="form-group">
											...
											<span class="form-text text-muted">Tamanho máx do arquivo 1Mb</span>
										</div>
									</fieldset>
								</div>
