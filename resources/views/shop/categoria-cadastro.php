				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<div class="d-flex justify-content-center">
							<a href="categoria-lista.php" class="btn btn-link btn-float text-default"><i class="icon-list text-primary"></i><span>Ver Todos</span></a>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-md-12">
									<fieldset>
										...
										<div class="form-group">
											<label>Categorias Pai:</label>
											<select class="form-control">
												<option value="">Selecione um Categorias</option>
												<option value="">Acessórios Masculinos</option>
												<option value="">Acessórios Masculinos > Mochilas</option>
											</select>
										</div>
										
										<div class="form-group">
											<label>Ícone no Nome da Categoria:</label>
											<input type="file" class="form-input-styled" data-fouc>
											<span class="form-text text-muted">Extenções aceitas: png, jpg. Tamanho máx do arquivo 2Mb</span>
										</div>

										<div class="form-group">
											<label>Banner Categoria:</label>
											<input type="file" class="form-input-styled" data-fouc>
											<span class="form-text text-muted">Extenções aceitas: png, jpg. Tamanho máx do arquivo 2Mb</span>
										</div>

										<div class="form-group">
											<label>Banner Sub-menu da Categoria:</label>
											<input type="file" class="form-input-styled" data-fouc>
											<span class="form-text text-muted">Extenções aceitas: png, jpg. Tamanho máx do arquivo 2Mb</span>
										</div>
										<div class="form-group">
