				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<div class="d-flex justify-content-center">
							<a href="/shop/product/departament-add" class="btn btn-link btn-float text-default"><i class="icon-googleplus5 text-primary"></i><span>Adicionar Novo</span></a>
						</div>
					</div>
				</div>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a href="/shop/product/departament-delete/{{$departament->id}}" class="dropdown-item"><i class="icon-close2"></i> Remover</a>
											</div>
										</div>
									</div>
								</td>
