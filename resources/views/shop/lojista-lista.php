			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Lojistas</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Lista de lojistas</span>
						</div>
				...
				<div class="card">
					...
					<table class="table datatable-show-all">
						...
						<tbody>
							<tr>
								<td>Marth</td>
								<td><a href="#">lojanova.com</a></td>
								<td>(62) 9998-9998</td>
								<td>empresa@empresa.com.br</td>
								<td>Roberto Alves</td>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a href="#" class="dropdown-item"><i class="icon-googleplus5"></i> Ver todos os dados</a>
											</div>
										</div>
									</div>
								</td>
