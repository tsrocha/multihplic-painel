			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Resgates</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Resgates</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header bg-transparent header-elements-inline">
						<h6 class="card-title">Solicitações de resgate</h6>
					...
					<table class="table table-lg invoice-archive">
						...
						<tbody>
							<tr>
				                ...
				                <td>
				                	<h6 class="mb-0">
				                		<a href="#">Ordem #215182</a>
				                		<span class="d-block font-size-sm text-muted">Depósito bancário</span>
			                		</h6>
			                	</td>
				                <td>
				                	<select name="status" class="form-control form-control-select2" data-placeholder="Select status">
				                		...
				                		<option value="cancel">Reprovado</option>
				                	</select>
			                	</td>
				                <td>
				                	<a href="#">@fornecedor1</a>
			                	</td>
				                <td>
							...
							<tr>
				                ...
				                <td>
				                	<select name="status" class="form-control form-control-select2" data-placeholder="Select status">
				                		<option value="hold">Aguardando</option>
				                		<option value="paid" selected>Aprovado</option>
				                		<option value="cancel">Reprovado</option>
				                	</select>
			                	</td>
				                <td>
				                ...
				                <td>
				                	<span class="badge badge-danger">29/03/2019</span>
			                	</td>
				                <td>
				                	<h6 class="mb-0 font-weight-bold">R$17.890,00 
										</h6>
