				...
				<div class="row">
                    ...
                    <div class="col-sm-6 col-xl-3">
						<div class="card">
							...
							<div style="width: 100%">
								@if(count($theme['theme_provider']) >= 1 && isset($theme['theme_provider'][0]) && $theme['theme_provider'][0]['provider_id'] == $company_id)
									<button class="btn btn-success w-100">Tema padrão</button>
								@else
								    <a href="/provider/tema/definir/{{$theme['id']}}" class="btn btn-primary w-100">Definir como tema padrão</a>
								@endif
