				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<div class="d-flex justify-content-center">
							<a href="/provider/product/category-add" class="btn btn-link btn-float text-default"><i class="icon-googleplus5 text-primary"></i><span>Adicionar Novo</span></a>
						</div>
					</div>
				</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Categorias registrados</h5>
					</div>
					...
					<table class="table datatable-show-all">
						...
						@foreach($categorys as $category)
							<tr>
								...
								<td>{{($category->status == 'active')? 'Ativo' : 'Inativo'}}</td>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a href="/provider/product/category-delete/{{$category->id}}" class="dropdown-item"><i class="icon-close2"></i> Remover</a>
											</div>
										</div>
									</div>
								</td>
