        ...
        <div class="row"> 
          ...
          <div class="col-md-3">
            <div class="shop-side-bar"> 
              ...
              <!-- Size -->
              <h6>Size</h6>
              <div class="sizes"> <a href="#.">S</a> <a href="#." class="choosed">M</a> <a href="#.">L</a> <a href="#.">XL</a> </div>
              ...
              <div class="checkbox checkbox-primary">
                <ul>
                  ...
                  <li>
                    ...
                    <label for="colr2"> Yellow   </label>
                  </li>
                  <li>
                    <input id="colr3" class="styled" type="checkbox" >
                    <label for="colr3"> Asus </label>
                  </li>
                  <li>
                    <input id="colr4" class="styled" type="checkbox" >
                    <label for="colr4">Black   </label>
                  </li>
                  <li>
                    <input id="colr5" class="styled" type="checkbox" >
                    <label for="colr5">Blue   </label>
                  </li>
                  <li>
                    <input id="colr6" class="styled" type="checkbox" >
                    <label for="colr6">Grey   </label>
                  </li>
                  <li>
                    <input id="colr7" class="styled" type="checkbox" >
                    <label for="colr7">Pink  </label>
                  </li>
                  <li>
                    <input id="colr8" class="styled" type="checkbox" >
                    <label for="colr8">White </label>
                  </li>
                  <li>
                    <input id="colr9" class="styled" type="checkbox" >
                    <label for="colr9">Green   </label>
                  </li>
