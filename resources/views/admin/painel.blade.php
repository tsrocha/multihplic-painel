            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="card bg-teal-400">
                        <div class="card-body">
                            <div class="d-flex">
                                <h3 class="font-weight-semibold mb-0">0,0</h3>
                                <span class="badge bg-teal-800 badge-pill align-self-center ml-auto">+0%</span>
                            </div>

                            <div>
                                Clientes
                                <div class="font-size-sm opacity-75">0 novos</div>
                            </div>
                        </div>
                    ...
                    <div class="card bg-pink-400">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <span class="badge bg-pink-800 badge-pill align-self-center ml-auto">+0%</span>
                            </div>
                            <div>
                                Pedidos
                                <div class="font-size-sm opacity-75">0 novos</div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card bg-blue-400">
                        <div class="card-body">
                            <div class="d-flex">
                                <h3 class="font-weight-semibold mb-0">R$ 0,00</h3>
                            ...
                            <div>
                                Receita de hoje
                                <div class="font-size-sm opacity-75">R$ 0,00</div>
                            </div>
                        </div>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
                            <div class="d-flex align-items-center mb-3 mb-sm-0">
                                ...
                                <div class="ml-3">
                                    <h5 class="font-weight-semibold mb-0">R$ 0,00 <span class="text-success font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i> (0%)</span></h5>
                                    <span class="badge badge-mark border-success mr-1"></span> <span class="text-muted">{{date('d/m/Y')}}</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-3 mb-sm-0">
                                ...
                                <div class="ml-3">
                                    <h5 class="font-weight-semibold mb-0">R$ 0 <span class="text-danger font-size-sm font-weight-normal"><i class="icon-arrow-down12"></i> (0%)</span></h5>
                                    <span class="badge badge-mark border-danger mr-1"></span> <span class="text-muted">{{date('d/m/Y')}}</span>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header header-elements-inline">
                            ...
                            <div class="header-elements">
                                <span><i class="icon-history text-warning mr-2"></i> {{date('d/m/Y H:i')}}</span>
