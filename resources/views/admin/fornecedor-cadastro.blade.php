			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="/admin/fornecedor/cadastro" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="main" value="yes" />

							<div class="row">
								<div class="col-md-6">
									<fieldset>
										<legend class="font-weight-semibold"><i class="icon-reading mr-2"></i> Dados do fornecedor</legend>
										...
										<div class="form-group">
											...
											<input type="text" name="fantasyName" class="form-control" placeholder="" required>
										</div>
										<div class="form-group">
											<label>Cnpj:</label>
											<input type="text" name="cpfCnpj" class="form-control" placeholder="" required>
										</div>
										<div class="form-group">
											<label>E-mail:</label>
											<input type="text" name="emailCompany" class="form-control" placeholder="" required>
										</div>
										<div class="form-group">
